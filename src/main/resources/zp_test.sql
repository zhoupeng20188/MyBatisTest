...
CREATE TABLE `comments` (
  ...
  `is_good_comment` int(11) DEFAULT NULL,
  `cotent` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `products` (
  ...
  PRIMARY KEY (`id`),
  KEY `index1` (`category`,`sub_category`) USING BTREE
